...
NOTE: Comments of this point for pull request related to different branches can be founde in the tutorial https://github.com/IMPRESSPROJECT/Useful-tutorials-. Here we focus on pull request of a forked repository.
...
requests show  differences (diffs) of the content from both repositories. The changes, additions, and subtractions are
